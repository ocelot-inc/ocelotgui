# rpmbuild.sh -- produce ocelotgui-2.3.0 .rpm from ~/ocelotgui
...
# For 2.3.0 32-bit ocelotgui was on Fedora 26 from archives.fedoraproject.org/pub/archive/fedora-secondary/releases/26, with pae.
...
# The result will be / ~/ocelotgui_rpm//rp/rpmbuild/RPMS/x86_64/ocelotgui-2.3.0-1.x86_64.rpm or  ~/ocelotgui_rpm//rp/rpmbuild/RPMS/i686/ocelotgui-2.3.0-1.i686.rpm
...
cp ~/ocelotgui-2.3.0/ocelotgui.spec $HOME/ocelotgui.spec

...
# rm -r -f _CPack*
# rm -f CMakeCache.txt
# rm -r -f ocelotgui-1.0.6/usr
# rm -r -f ocelotgui_autogen*
# cmake . -DQT_VERSION=5 -DCPACK_GENERATOR="RPM" -DCMAKE_INSTALL_PREFIX="ocelotgui-1.0.6/usr"
# make
# make install
# chmod +x rpm_build.sh
# ./rpm_build.sh
# rpmlint ./rp/rpmbuild/RPMS/ocelotgui-1.0.6-1.x86_64.rpm

# We produced ocelotgui-1.0.6qt4-1.x86_64.rpm the same way, except:
# yum install qt4-devel
# cmake . -DQT_VERSION=4 -DCPACK_GENERATOR="RPM" -DCMAKE_INSTALL_PREFIX="ocelotgui-1.0.6/usr"
# cmake . -DQT_VERSION=4 -DCPACK_GENERATOR="RPM" -DFILENAME_EXTRA="qt4" -DCMAKE_INSTALL_PREFIX="ocelotgui-1.0.6/usr"
# (filename has to be changed manually, dunno why -DFILENAME_EXTRA didn't work)
# rpmlint ./rp/rpmbuild/RPMS/ocelotgui-1.0.6qt4-1.x86_64.rpm

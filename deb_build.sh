# deb_build.sh -- produce ocelotgui-2.3.0 .deb from ~/ocelotgui
...
# The result will be /tmp/debian3/ocelotgui_2.3.0-1_amd64.deb or /tmp/debian3/ocelotgui_2.3.0-1_i386.deb.

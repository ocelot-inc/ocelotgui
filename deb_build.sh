# deb_build.sh -- produce ocelotgui-1.0.9 .deb from ~/ocelotgui
...
# The result will be /tmp/debian3/ocelotgui_1.0.9-1_amd64.deb or /tmp/debian3/ocelotgui_1.0.9-1_i386.deb.

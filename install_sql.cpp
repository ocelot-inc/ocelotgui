...
"      IF CAST(@xxxmdbug_uvar_type AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='LONGTEXT' AND (LEFT(v_condition_value,1) <>'''' OR RIGHT(v_condition_value,1) <>'''') THEN"
...
"  IF (SELECT COUNT(*) FROM information_schema.routines" 
"      WHERE routine_schema COLLATE utf8_general_ci =v_schema_identifier AND routine_name COLLATE utf8mb3_general_ci =v_routine_identifier)=0 THEN"
"    SIGNAL SQLSTATE '05678' SET mysql_errno=@xxxmdbug_signal_errno, message_text= 'Routine not found';" 
"    END IF;" 
...
"      SET @xxxmdbug_uvar=@xxxmdbug_token_value_4a;" 
"      CALL xxxmdbug.uvar(v_junk,''); /* returns @xxxmdbug_uvar_type */" 
"      IF CAST(@xxxmdbug_uvar_type AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='LONGTEXT' AND (LEFT(break_token,1) <>'''' OR RIGHT(break_token,1) <>'''') THEN"
"        SIGNAL SQLSTATE '05678' SET mysql_errno=@xxxmdbug_signal_errno, message_text= 'String literals must be inside ''quote marks''';" 
"        END IF;" 
"" 
...
"                           AND specific_name  COLLATE utf8_general_ci  =v_surrogate_routine_identifier"
"                           AND LEFT(routine_type  COLLATE utf8_general_ci,1) =v_routine_type"
...
"    IF CAST(@xxxmdbug_char AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = '.' THEN"
...
"        END IF;" 
"      END IF;" 
"    IF (CAST(@xxxmdbug_char AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = '+' OR CAST(@xxxmdbug_char AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = '-')"
...
"        END IF;" 
"      END IF;" 
"    IF CAST(@xxxmdbug_char AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN ('`',CHAR(39),'\"') THEN"
...
"        SET i = i + 1;" 
"        IF CAST(@xxxmdbug_char_in_string AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = CHAR(10) THEN"
"          IF is_body = 1 THEN SET current_line_number = current_line_number + 1; END IF;" 
"          END IF;" 
"        IF CAST(@xxxmdbug_char_in_string AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   = @xxxmdbug_end_char THEN"
...
"    IF CAST(@xxxmdbug_2_chars AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = '/*' THEN"
...
"      END IF;" 
"" 
"    IF CAST(@xxxmdbug_char AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci IN ('-','+')"
"    AND token=''" 
...
"      SET token_offset = i;" 
"      SET token_line_number = current_line_number;" 
"      IF CAST(@xxxmdbug_2_chars AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  IN ('&&',':=','<=','>=','<<','>>','<>','||','!=','@@') THEN"
"        SET @xxxmdbug_3_chars  = SUBSTRING(body FROM i FOR 3);"
"        IF CAST(@xxxmdbug_3_chars AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = '<=>' THEN"
...
"        IF CAST(@xxxmdbug_char AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = CHAR(10) THEN"
"          IF is_body=1 THEN SET current_line_number = current_line_number + 1; END IF;" 
"          END IF;" 
"        SET token = '';" 
"        SET i = i + 1;" 
...
"" 
"  IF CAST(@xxxmdbug_call_stack AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='' THEN"
...
"  /* if it doesn't start with line_number, then it must be starting with [[schema_identifier.]routine_identifier] */" 
"" 
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'tbreakpoint' THEN SET v_is_temporary = 1; END IF;"
"" 
"  SET break_token_number = 2;" 
...
"    END IF;" 
"" 
"  IF break_is_bad_syntax = 0 AND CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'clear' THEN"
...
"    END IF;" 
"" 
"  IF break_is_bad_syntax = 0 AND (CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'breakpoint' OR CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'tbreakpoint') THEN"
...
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='next' THEN"
...
"  DECLARE v_row_count INT;" 
"" 
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'breakpoint' OR CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = 'tbreakpoint' OR CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = 'clear' THEN"
"    CALL xxxmdbug.icc_process_user_command_break();" 
"    END IF;" 
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'refresh' THEN"
"    IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = 'call_stack' THEN"
"      CALL xxxmdbug.icc_process_user_command_r_call_stack();" 
"      END IF;" 
"    IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'breakpoints' THEN"
"      CALL xxxmdbug.icc_process_user_command_r_breakpoints();" 
"      END IF;" 
"    IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'variables' THEN"
"      CALL xxxmdbug.icc_process_user_command_r_variables();" 
"      END IF;" 
"    IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'server_variables' THEN"
"      CALL xxxmdbug.icc_process_user_command_r_server_variables();" 
"      END IF;" 
"    IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'statements_executed' THEN"
"      CALL xxxmdbug.icc_process_user_command_r_statements_executed();" 
"      END IF;" 
"    IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'prepared_statements' THEN"
"      CALL xxxmdbug.icc_process_user_command_r_prepared_statements();" 
"      END IF;" 
"    /* a check for user_variables is deliberately not here */" 
"    END IF;" 
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'set' THEN"
"    CALL xxxmdbug.icc_process_user_command_set();" 
"    END IF;" 
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'execute' THEN"
"    CALL xxxmdbug.icc_process_user_command_execute();" 
"    END IF;" 
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'delete' THEN"
...
"      IF v_table_breakpoint_identifier=@xxxmdbug_token_value_2 OR @xxxmdbug_token_value_2 IS NULL OR CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = '' THEN"
"        CALL xxxmdbug.breakpoint_delete(v_n);" 
"        SET v_row_count=v_row_count+1;" 
...
"    END IF;" 
"" 
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'debug' THEN"
...
"   IF CAST(@xxxmdbug_token_value_4 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci was not passed within ''s, it must be a number."
...
"  DECLARE j,k,l INT;" 
"" 
"  IF LEFT(CAST(@xxxmdbug_token_value_4 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,1) ='''' THEN"
...
"    LEAVE retype;" 
"    END IF;" 
"  IF CAST(@xxxmdbug_token_value_4 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='null' THEN"
"    SET i_longblob=NULL; SET @xxxmdbug_token_value_4a=i_longblob;" 
"    LEAVE retype;" 
"    END IF;" 
"  IF LEFT(CAST(@xxxmdbug_token_value_4 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,2) ='0x' THEN"
"    SET i_longblob='';" 
"    SET j = 3;" 
...
"    LEAVE retype;" 
"    END IF;" 
"  IF CAST(@xxxmdbug_token_value_4 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   LIKE '%e%' THEN"
"    SET i_double=@xxxmdbug_token_value_4; SET @xxxmdbug_token_value_4a=i_double;" 
"    LEAVE retype;" 
"    END IF;" 
"  IF CAST(@xxxmdbug_token_value_4 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   LIKE '%.%' THEN"
...
"    END IF;" 
"" 
"  IF LEFT(CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,2) ='@@' THEN"
...
"    END IF;" 
"" 
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN ('step','next') THEN CALL xxxmdbug.icc_process_user_command_step_or_next(); END IF;"
"" 
"  SET result = 0;" 
"  CALL xxxmdbug.get_current_schema_identifier_and_routine_identifier(v_schema,v_routine,v_routine_type);" 
"  /* OPEN c; */" 
...
"    IF CAST(@xxxmdbug_message AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  <= '' AND with_wait=1 THEN ITERATE x; END IF;"
"    LEAVE x;" 
"    END LOOP;" 
"  /* todo: see if you can get rid of @xxxmdbug_status_last_command and just use @xxxmdbug_message */" 
"  IF CAST(@xxxmdbug_message AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  > '' THEN"
...
"IF CAST(@xxxmdbug_message AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci is null then signal sqlstate '05678' set mysql_errno=@xxxmdbug_signal_errno,message_text = 'assert. @xxxmdbug_message is null'; end if;"
...
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('attach',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='attach'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('breakpoint',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='breakpoint'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('clear',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='clear'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('continue',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='continue'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('debug',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='debug'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('delete',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='delete'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('execute',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='execute'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('exit',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='exit'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('leave',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='leave'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('next',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='next'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('refresh',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='refresh'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('set',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='set'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('skip',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='skip'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('step',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='step'; END IF;"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci=LEFT('tbreakpoint',@xxxmdbug_token_value_1_length) THEN SET @xxxmdbug_token_value_1='tbreakpoint'; END IF;"
"    END IF;" 
"  /* Usually 'execute' is in the IN list, but not this time, because 'execute' does its own call to icc_change_statement_status. */" 
"  IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN ('attach','continue','exit','leave','next','skip','step') THEN CALL xxxmdbug.icc_change_statement_status('OK'); END IF;"
"" 
"  END");
...
"    IF CAST(@xxxmdbug_message AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  <= 0x20 THEN LEAVE x1; END IF; /* if empty queue, go on */"
"    IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN ('continue','exit','leave','next','execute','skip','step') THEN LEAVE x1; END IF; /* if motion causer, go on */"
...
"    x2: LOOP" 
"      IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN ('continue','exit','leave','next','execute','skip','step') THEN"
"        LEAVE x2;" 
...
"      IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN ('next','step') THEN CALL xxxmdbug.icc_process_user_command_step_or_next(); END IF;"
"      IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN ('continue','exit','leave','next','execute','skip','step') THEN"
"        LEAVE x2;"
"        END IF; /* if motion causer, go on */" 
"    /* This is replaced with :IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = 'user_variables' ,,,\" in the generated icc_core (if track_user_variables=1). */"
"      CALL xxxmdbug.icc_process_user_command();" 
"      CALL xxxmdbug.icc_send_statement_status('icc_core');" 
"      END LOOP;" 
"" 
...
"      LEAVE x1;" 
"      END IF;" 
"    IF CAST(@xxxmdbug_uvar AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci IS NULL THEN"
...
"      END IF;" 
"    IF i_longblob >= 0 THEN" 
"      IF CAST(@xxxmdbug_uvar AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci <> CONCAT('0',i_longblob) THEN"
"        SET @xxxmdbug_uvar_type = 'LONGBLOB';" 
"        LEAVE x1;" 
"        END IF;" 
"      END IF;" 
...
"                   'IF CAST(@xxxmdbug_message AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  <= 0x20 THEN LEAVE x1; END IF;',@xxxmdbug_lf,"
"                   'IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN (''continue'',''exit'',''leave'',''next'',''execute'',''skip'',''step'') THEN LEAVE x1; END IF;',@xxxmdbug_lf,"
"                   'IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = ''user_variables'' THEN',@xxxmdbug_lf,"
...
"                       'END IF;',@xxxmdbug_lf);" 
"" 
"  SET v_g = concat(v_g,'IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = ''set'' AND LEFT(CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,1) = ''@'' AND LEFT(CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,2) <> ''@@'' THEN',@xxxmdbug_lf,"
...
"    SET v_g = CONCAT(v_g,'IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = ''',"
"                         v_variable_name,"
...
"                       'x2: LOOP',@xxxmdbug_lf," 
"                       'IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci IN (''continue'',''exit'',''leave'',''next'',''execute'',''skip'',''step'') THEN',@xxxmdbug_lf,"
"                       'LEAVE x2;',@xxxmdbug_lf,"
"                       'END IF;',@xxxmdbug_lf," 
"                       'CALL xxxmdbug.icc_get_user_command(1);',@xxxmdbug_lf," 
"                       'IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci IN (''next'',''step'') THEN CALL xxxmdbug.icc_process_user_command_step_or_next(); END IF;',@xxxmdbug_lf,"
"                       'IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci IN (''continue'',''exit'',''leave'',''next'',''execute'',''skip'',''step'') THEN',@xxxmdbug_lf,"
"                       'LEAVE x2;',@xxxmdbug_lf,"
"                       'END IF;',@xxxmdbug_lf," 
"                       'IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = ''user_variables'' THEN',@xxxmdbug_lf,"
...
"" 
"  SELECT MAX(name) INTO v_max_name FROM mysql.proc WHERE name COLLATE utf8_bin  LIKE 'xxxmdbug____%';"
...
"    IF CAST(@xxxmdbug_setup_group_name AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='ZZZ' THEN"
...
"            IF CAST(@xxxmdbug_tmp_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci <> ',' THEN"
...
"        IF CAST(@xxxmdbug_x AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  <> ',' THEN LEAVE x2; END IF;                       /* (token (#x) is not ',' */"
"        END LOOP;" 
"      SET v_type = '';                                            /* we're about to see the type */" 
"      x3: LOOP" 
"        SET @xxxmdbug_x = (SELECT value FROM xxxmdbug.tokens WHERE token_number = v_token_number_x);" 
"        IF CAST(@xxxmdbug_x AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = ';' OR CAST(@xxxmdbug_x AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'DEFAULT' THEN LEAVE x3; END IF;      /* (token (#x+1) is not statement end */"
...
"        SET k = k + 1;" 
"        IF CAST(@xxxmdbug_a5 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='*' OR CAST(@xxxmdbug_a5 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci =';' OR CAST(@xxxmdbug_a5 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='' THEN LEAVE y; END IF;"
...
"      IF LEFT(CAST(@xxxmdbug_x AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,1)   BETWEEN 'A' AND 'Z'"
"      OR LEFT(CAST(@xxxmdbug_x AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,1)   BETWEEN '0' AND '9'"
"      OR LEFT(CAST(@xxxmdbug_x AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,1)  = '$'"
"      OR HEX(LEFT(CAST(@xxxmdbug_x AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,1))  >= '80'"
"      OR LEFT(CAST(@xxxmdbug_x AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,1) ='`'"
"      OR (LEFT(CAST(@xxxmdbug_x AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci,1) ='\"' AND mysql_proc_sql_mode   LIKE '%ansi_quotes%') THEN"
...
"      CALL xxxmdbug.icc_get_user_command(0);" 
"      IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = LEFT('attach',LENGTH(@xxxmdbug_token_value_1)) THEN LEAVE x; END IF;"
"      END LOOP;" 
...
"        END IF;" 
"" 
"      IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='attach' THEN"
"        /* obsolete: SET @xxxmdbug_status_last_command = @xxxmdbug_message; */" 
"        /* obsolete: CALL xxxmdbug.icc_change_statement_status('\"OK\"'); */" 
"        CALL xxxmdbug.icc_send_statement_status('debuggee_wait_loop');" 
"        ITERATE x;" 
"        END IF;" 
"      IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='exit' THEN"
"        SIGNAL SQLSTATE '56780' set mysql_errno=@xxxmdbug_signal_errno,message_text='exit command received';" 
"        END IF;" 
"      IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN ('breakpoint','tbreakpoint','clear','refresh','delete','execute') THEN"
"        IF CAST(@xxxmdbug_token_value_2 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = 'user_variables' THEN"
...
"      IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci   IN ('continue','leave','next','skip','step') THEN "
"        SET @xxxmdbug_status_last_command = @xxxmdbug_message;" 
...
"       IF CAST(@xxxmdbug_token_value_3 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci ='.' THEN"
...
"      IF CAST(@xxxmdbug_status_last_command_result AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  > '' THEN"
"        SET @xxxmdbug_status_last_command = @xxxmdbug_message;" 
...
"     AND (routine_name COLLATE utf8mb3_general_ci   LIKE CONCAT('xxxmdbug___P',v_routine_identifier2)"
"          OR routine_name COLLATE utf8mb3_general_ci    LIKE CONCAT('xxxmdbug___F',v_routine_identifier2));"
"" 
...
"           AND routine_name  COLLATE utf8mb3_general_ci =TRIM(BOTH '`' FROM v_original_routine_identifier)"
"           AND LEFT(routine_type  COLLATE utf8_general_ci,1) =v_routine_type;"
...
"    SELECT last_altered INTO v_last_altered FROM information_schema.routines" 
"           WHERE routine_schema COLLATE utf8_general_ci=TRIM(BOTH '`' FROM v_schema_identifier)"
"           AND routine_name  COLLATE utf8mb3_general_ci =TRIM(BOTH '`' FROM v_surrogate_routine_identifier)"
"           AND LEFT(routine_type COLLATE utf8_general_ci,1) =v_routine_type;"
"    IF v_last_altered IS NULL THEN" 
...
"        SET v_g = CONCAT(v_g,@xxxmdbug_lf," 
"        'IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci  = ''exit'' THEN SIGNAL sqlstate ''56780'' SET mysql_errno = @xxxmdbug_signal_errno; END IF;');"
"" 
...
"        SET v_g = CONCAT(v_g,'IF @xxxmdbug_breakpoint_check_result>0 AND (CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = ''set'' OR CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = ''execute'') THEN ITERATE ',inner_loop_label,'; END IF;',@xxxmdbug_lf);"
"" 
"        /* Check @@warning_count. */" 
...
"          SET v_g = CONCAT(v_g,@xxxmdbug_lf,'IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = ''leave'' THEN LEAVE ',"
...
"      SET v_g = CONCAT(v_g,'IF CAST(@xxxmdbug_token_value_1 AS CHAR(64) CHARACTER SET utf8mb4) COLLATE utf8mb4_general_ci = ''skip'' THEN LEAVE ',inner_loop_label,'; END IF;',@xxxmdbug_lf);"
"" 
...
"    AND name COLLATE utf8_general_ci = TRIM(BOTH '`' FROM v_routine_identifier_of_original);"
"" 
"    CALL xxxmdbug.add_delimiters(mysql_proc_db);" 
"    CALL xxxmdbug.add_delimiters(mysql_proc_name);" 
"" 
...
"v_body_utf8 "
"FROM mysql.proc "
"WHERE db COLLATE utf8_bin =p_db AND name COLLATE utf8_general_ci =p_name "
"LIMIT 1; "
"" 
...
"      IF (SELECT COUNT(*)" 
"          FROM mysql.proc" 
"          WHERE db = 'xxxmdbug' COLLATE utf8_bin AND name COLLATE utf8mb3_general_ci = v_routine_identifier_of_surrogate"
"          LIMIT 1) = 1 THEN" 
"        ITERATE x;" 
"        END IF;" 
"      END IF;" 

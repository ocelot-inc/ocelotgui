...
static int MENU_STATEMENT_TEXT_COLOR= 73;
static int MENU_STATEMENT_BACKGROUND_COLOR= 74;
static int MENU_STATEMENT_HIGHLIGHT_LITERAL_COLOR= 75;
static int MENU_STATEMENT_HIGHLIGHT_IDENTIFIER_COLOR= 76;
static int MENU_STATEMENT_HIGHLIGHT_COMMENT_COLOR= 77;
static int MENU_STATEMENT_HIGHLIGHT_OPERATOR_COLOR= 78;
static int MENU_STATEMENT_HIGHLIGHT_KEYWORD_COLOR= 79;
static int MENU_STATEMENT_PROMPT_BACKGROUND_COLOR= 80;
static int MENU_STATEMENT_BORDER_COLOR= 81;
static int MENU_STATEMENT_HIGHLIGHT_CURRENT_LINE_COLOR= 82;
static int MENU_STATEMENT_HIGHLIGHT_FUNCTION_COLOR= 83;
static int MENU_GRID_TEXT_COLOR= 84;
static int MENU_GRID_BACKGROUND_COLOR= 85;
static int MENU_GRID_CELL_BORDER_COLOR= 86;
static int MENU_GRID_OUTER_COLOR= 87;
static int MENU_GRID_HEADER_BACKGROUND_COLOR= 88;
static int MENU_GRID_FOCUS_CELL_BACKGROUND_COLOR= 89;
static int MENU_GRID_CELL_HEIGHT= 90;
static int MENU_GRID_CELL_BORDER_SIZE= 91;
static int MENU_GRID_CELL_WIDTH= 92;
static int MENU_HISTORY_TEXT_COLOR= 93;
static int MENU_HISTORY_BACKGROUND_COLOR= 94;
static int MENU_HISTORY_BORDER_COLOR= 95;
static int MENU_MENU_TEXT_COLOR= 96;
static int MENU_MENU_BACKGROUND_COLOR= 97;
static int MENU_MENU_BORDER_COLOR= 98;
static int MENU_FONT= 99;
static int MENU_MAX_ROW_COUNT= 100;
static int MENU_SYNTAX_CHECKER=101;
static int MENU_DETACHED= 102;
static int MENU_TOP= 103;
static int MENU_LEFT= 104;
static int MENU_WIDTH= 105;
static int MENU_HEIGHT= 106;
static int MENU_CONDITION= 107;
static int MENU_DISPLAY_AS= 108;
static int MENU_CANCEL= 109;
static int MENU_OK= 110;
static int MENU_SETTINGS_FOR_MENU= 111;
static int MENU_SETTINGS_FOR_HISTORY= 112;
static int MENU_SETTINGS_FOR_GRID= 113;
static int MENU_SETTINGS_FOR_STATEMENT= 114;
static int MENU_SETTINGS_FOR_DEBUG= 115;
static int MENU_SETTINGS_FOR_EXTRA_RULE_1= 116;
static int MENU_SETTINGS_FOR_EXPLORER= 117;
static int MENU_GRID_HTML_EFFECTS= 118; /* was MENU_PICK_NEW_FONT= 111; until version 1.5 */

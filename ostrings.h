...
#define MENU_RUN       16
#define MENU_RUN_EXECUTE       17
#define MENU_RUN_KILL       18
#define MENU_SETTINGS       19
#define MENU_SETTINGS_MENU       20
...
#define MENU_OPTIONS_DETACH_STATEMENT_WIDGET 30
#define MENU_OPTIONS_NEXT_WINDOW 31
#define MENU_OPTIONS_PREVIOUS_WINDOW 32
#define MENU_OPTIONS_CHANGE_RESULT_DISPLAY 33
#define MENU_DEBUG       34
#define MENU_DEBUG_INSTALL       35
#define MENU_DEBUG_SETUP       36
#define MENU_DEBUG_DEBUG       37
#define MENU_DEBUG_BREAKPOINT       38
#define MENU_DEBUG_CONTINUE       39
#define MENU_DEBUG_LEAVE       40
#define MENU_DEBUG_NEXT       41
#define MENU_DEBUG_SKIP       42
#define MENU_DEBUG_STEP       43
#define MENU_DEBUG_CLEAR       44
#define MENU_DEBUG_DELETE       45
#define MENU_DEBUG_EXIT       46
#define MENU_DEBUG_INFORMATION       47
#define MENU_DEBUG_REFRESH_SERVER_VARIABLES       48
#define MENU_DEBUG_REFRESH_USER_VARIABLES       49
#define MENU_DEBUG_REFRESH_VARIABLES       50
#define MENU_DEBUG_REFRESH_CALL_STACK       51
#define MENU_HELP       52
#define MENU_HELP_ABOUT       53
#define MENU_HELP_THE_MANUAL       54
#define MENU_HELP_LIBMYSQLCLIENT       55
#define MENU_HELP_SETTINGS       56
static int MENU_STATEMENT_TEXT_COLOR= 57;
static int MENU_STATEMENT_BACKGROUND_COLOR= 58;
static int MENU_STATEMENT_HIGHLIGHT_LITERAL_COLOR= 59;
static int MENU_STATEMENT_HIGHLIGHT_IDENTIFIER_COLOR= 60;
static int MENU_STATEMENT_HIGHLIGHT_COMMENT_COLOR= 61;
static int MENU_STATEMENT_HIGHLIGHT_OPERATOR_COLOR= 62;
static int MENU_STATEMENT_HIGHLIGHT_KEYWORD_COLOR= 63;
static int MENU_STATEMENT_PROMPT_BACKGROUND_COLOR= 64;
static int MENU_STATEMENT_BORDER_COLOR= 65;
static int MENU_STATEMENT_HIGHLIGHT_CURRENT_LINE_COLOR= 66;
static int MENU_STATEMENT_HIGHLIGHT_FUNCTION_COLOR= 67;
static int MENU_GRID_TEXT_COLOR= 68;
static int MENU_GRID_BACKGROUND_COLOR= 69;
static int MENU_GRID_CELL_BORDER_COLOR= 70;
static int MENU_GRID_CELL_DRAG_LINE_COLOR= 71;
static int MENU_GRID_HEADER_BACKGROUND_COLOR= 72;
static int MENU_GRID_BORDER_COLOR= 73;
static int MENU_GRID_BORDER_SIZE= 74;
static int MENU_GRID_CELL_BORDER_SIZE= 75;
static int MENU_GRID_CELL_DRAG_LINE_SIZE= 76;
static int MENU_HISTORY_TEXT_COLOR= 77;
static int MENU_HISTORY_BACKGROUND_COLOR= 78;
static int MENU_HISTORY_BORDER_COLOR= 79;
static int MENU_MENU_TEXT_COLOR= 80;
static int MENU_MENU_BACKGROUND_COLOR= 81;
static int MENU_MENU_BORDER_COLOR= 82;
static int MENU_FONT= 83;
static int MENU_MAX_ROW_COUNT= 84;
static int MENU_SYNTAX_CHECKER= 85;
static int MENU_DETACHED= 86;
static int MENU_TOP= 87;
static int MENU_LEFT= 88;
static int MENU_WIDTH= 89;
static int MENU_HEIGHT= 90;
static int MENU_CONDITION= 91;
static int MENU_DISPLAY_AS= 92;
static int MENU_CANCEL= 93;
static int MENU_OK= 94;
static int MENU_SETTINGS_FOR_MENU= 95;
static int MENU_SETTINGS_FOR_HISTORY= 96;
static int MENU_SETTINGS_FOR_GRID= 97;
static int MENU_SETTINGS_FOR_STATEMENT= 98;
static int MENU_SETTINGS_FOR_DEBUG= 99;
static int MENU_SETTINGS_FOR_EXTRA_RULE_1= 100;
static int MENU_PICK_NEW_FONT= 101;
#define MENU_CONNECTION_DIALOG_BOX 102
#define MENU_FILE_CONNECT_HEADING 103
#define MENU_END 104
...
"change result display", /* MENU_OPTIONS_CHANGE_RESULT_DISPLAY */
"Debug", /* MENU_DEBUG */
...
"settings", /* MENU_HELP_SETTINGS */
    ...
    "Format", /* MENU_EDIT_FORMAT */
    "Zoom avant", /* MENU_EDIT_ZOOMIN */
    "Zoom arrière", /* MENU_EDIT_ZOOMOUT */
    "Autoachever", /* MENU_EDIT_AUTOCOMPLETE */
    "Courir", /* MENU_RUN */
    ...
    "changer l'affichage des résultats" /* MENU_OPTIONS_CHANGE_RESULT_DISPLAY */
    "Debug", /* MENU_DEBUG */
    "Install", /* MENU_DEBUG_INSTALL */
    "Setup", /* MENU_DEBUG_SETUP */
    "Debug", /* MENU_DEBUG_DEBUG */

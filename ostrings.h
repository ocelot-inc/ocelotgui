...
#define MENU_DEBUG       49
#define MENU_DEBUG_INSTALL       50
#define MENU_DEBUG_SETUP       51
#define MENU_DEBUG_DEBUG       52
#define MENU_DEBUG_BREAKPOINT       53
#define MENU_DEBUG_CONTINUE       54
#define MENU_DEBUG_LEAVE       55
#define MENU_DEBUG_NEXT       56
#define MENU_DEBUG_SKIP       57
#define MENU_DEBUG_STEP       58
#define MENU_DEBUG_CLEAR       59
#define MENU_DEBUG_DELETE       60
#define MENU_DEBUG_EXIT       61
#define MENU_DEBUG_INFORMATION       62
#define MENU_DEBUG_REFRESH_SERVER_VARIABLES       63
#define MENU_DEBUG_REFRESH_USER_VARIABLES       64
#define MENU_DEBUG_REFRESH_VARIABLES       65
#define MENU_DEBUG_REFRESH_CALL_STACK       66
#define MENU_HELP       67
#define MENU_HELP_ABOUT       68
#define MENU_HELP_THE_MANUAL       69
#define MENU_HELP_LIBMYSQLCLIENT       70
#define MENU_HELP_SETTINGS       71
static int MENU_STATEMENT_TEXT_COLOR= 72;
static int MENU_STATEMENT_BACKGROUND_COLOR= 73;
static int MENU_STATEMENT_HIGHLIGHT_LITERAL_COLOR= 74;
static int MENU_STATEMENT_HIGHLIGHT_IDENTIFIER_COLOR= 75;
static int MENU_STATEMENT_HIGHLIGHT_COMMENT_COLOR= 76;
static int MENU_STATEMENT_HIGHLIGHT_OPERATOR_COLOR= 77;
static int MENU_STATEMENT_HIGHLIGHT_KEYWORD_COLOR= 78;
static int MENU_STATEMENT_PROMPT_BACKGROUND_COLOR= 79;
static int MENU_STATEMENT_BORDER_COLOR= 80;
static int MENU_STATEMENT_HIGHLIGHT_CURRENT_LINE_COLOR= 81;
static int MENU_STATEMENT_HIGHLIGHT_FUNCTION_COLOR= 82;
static int MENU_GRID_TEXT_COLOR= 83;
static int MENU_GRID_BACKGROUND_COLOR= 84;
static int MENU_GRID_CELL_BORDER_COLOR= 85;
static int MENU_GRID_OUTER_COLOR= 86;
static int MENU_GRID_HEADER_BACKGROUND_COLOR= 87;
static int MENU_GRID_FOCUS_CELL_BACKGROUND_COLOR= 88;
static int MENU_GRID_CELL_HEIGHT= 89;
static int MENU_GRID_CELL_BORDER_SIZE= 90;
static int MENU_GRID_CELL_WIDTH= 91;
static int MENU_HISTORY_TEXT_COLOR= 92;
static int MENU_HISTORY_BACKGROUND_COLOR= 93;
static int MENU_HISTORY_BORDER_COLOR= 94;
static int MENU_MENU_TEXT_COLOR= 95;
static int MENU_MENU_BACKGROUND_COLOR= 96;
static int MENU_MENU_BORDER_COLOR= 97;
static int MENU_FONT= 98;
static int MENU_MAX_ROW_COUNT= 99;
static int MENU_SYNTAX_CHECKER=100;
static int MENU_DETACHED= 101;
static int MENU_TOP= 102;
static int MENU_LEFT= 103;
static int MENU_WIDTH= 104;
static int MENU_HEIGHT= 105;
static int MENU_CONDITION= 106;
static int MENU_DISPLAY_AS= 107;
static int MENU_CANCEL= 108;
static int MENU_OK= 109;
static int MENU_SETTINGS_FOR_MENU= 110;
static int MENU_SETTINGS_FOR_HISTORY= 111;
static int MENU_SETTINGS_FOR_GRID= 112;
static int MENU_SETTINGS_FOR_STATEMENT= 113;
static int MENU_SETTINGS_FOR_DEBUG= 114;
static int MENU_SETTINGS_FOR_EXTRA_RULE_1= 115;
static int MENU_SETTINGS_FOR_EXPLORER= 116;
static int MENU_GRID_HTML_EFFECTS= 117; /* was MENU_PICK_NEW_FONT= 111; until version 1.5 */
#define MENU_CONNECTION_DIALOG_BOX 118
#define MENU_FILE_CONNECT_HEADING 119
#define MENU_END 120

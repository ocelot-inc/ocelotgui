...
*/
int MainWindow::hparse_f_literal(unsigned char reftype, unsigned short int flag_version,int token_literal_flags)
{
  if (hparse_errno > 0) return 0;
  if ((hparse_dbms_mask & flag_version) == 0) return 0;
...
int MainWindow::hparse_f_accept_qualifier(unsigned short int flag_version, unsigned char reftype, int proposed_type, QString token)
{
  if ((hparse_dbms_mask & FLAG_VERSION_MYSQL_OR_MARIADB_ALL) == 0)
...
void MainWindow::hparse_f_opr_18(int who_is_calling, int allow_flags) /* Precedence = 18, top */
{
  ...
  if ((hparse_dbms_mask & FLAG_VERSION_MARIADB_10_3) != 0)
  {
     ...
     || (hparse_token.toUpper() == "PREVIOUS"))
    {
      if (hparse_next_token.toUpper() == "VALUE")
      {
        ...
        if (hparse_errno > 0) return;
        if (hparse_f_qualified_name_of_object(TOKEN_REFTYPE_DATABASE_OR_SEQUENCE,TOKEN_REFTYPE_SEQUENCE) == 0)
          hparse_f_error();
        if (hparse_errno > 0) return;
        return;
      }
  ...
  if ((identifier_seen == true)
   || (hparse_f_qualified_name_of_operand(true,true,true) == 1))
  {
    if (hparse_errno > 0) return;
                                     ...
                                     bool persist_seen_earlier)
{
  ...
  do
  {
    ...
    {
      if (hparse_f_qualified_name_of_operand(true,false,false) == 0) hparse_f_error();
    }
    else /* TOKEN_KEYWORD_INSERT | UPDATE | LOAD */
    {
      if (hparse_f_qualified_name_of_operand(true,false,true) == 0) hparse_f_error();
    }
    if (hparse_errno > 0) return;
...
void MainWindow::hparse_f_create_function_clauses()
{
  ...
  if (hparse_errno > 0) return;
  if ((hparse_dbms_mask & FLAG_VERSION_PLSQL) != 0)
    hparse_f_expect(FLAG_VERSION_MYSQL_OR_MARIADB_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_KEYWORD, "RETURN");
  else
...
void MainWindow::hparse_f_limit(int who_is_calling)
{
  ...
  {
    if (hparse_f_literal(TOKEN_REFTYPE_ANY, FLAG_VERSION_ALL, TOKEN_LITERAL_FLAG_UNSIGNED_INTEGER) == 0)
    {
      hparse_f_expect(FLAG_VERSION_ALL, TOKEN_REFTYPE_VARIABLE,TOKEN_TYPE_IDENTIFIER, "[identifier]");
      if (hparse_errno > 0) return;
    }
    if ((who_is_calling == TOKEN_KEYWORD_DELETE) || (who_is_calling == TOKEN_KEYWORD_UPDATE) || (who_is_calling == TOKEN_KEYWORD_GROUP_CONCAT)) return;
    if ((hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_OPERATOR, ",") == 1)
...
void MainWindow::hparse_f_statement(int block_top)
{
  ...
  else if (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_KEYWORD_CREATE, "CREATE"))
  {
    ...
    else if (((hparse_flags & HPARSE_FLAG_PACKAGE) != 0) && (hparse_f_accept(FLAG_VERSION_PLSQL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_KEYWORD, "PACKAGE") == 1))
    {
      ...
      hparse_f_if_not_exists();
      if (hparse_errno > 0) return;
      if (hparse_f_qualified_name_of_object(TOKEN_REFTYPE_DATABASE_OR_PACKAGE, TOKEN_REFTYPE_PACKAGE) == 0) hparse_f_error();
      hparse_f_characteristics();
      if (hparse_errno > 0) return;
    ...
    else if (((hparse_flags & HPARSE_FLAG_TABLE) != 0) && (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_KEYWORD_TABLE, "TABLE") == 1))
    {
      ...
      else if (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_OPERATOR, "(") == 1)
      {
        ...
        do
        {
          comma_is_seen= false;
          item_is_seen= false;
          if (hparse_f_qualified_name_of_operand(false,false,true) == 1)
          {
            hparse_f_column_definition();
            if (hparse_errno > 0) return;
            item_is_seen= true;
  ...
  else if (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_KEYWORD_DROP, "DROP"))         /* drop database/event/etc. */
  {
    ...
    else if ((online_seen == false) && (hparse_f_accept(FLAG_VERSION_MARIADB_10_3, TOKEN_REFTYPE_ANY,TOKEN_TYPE_KEYWORD, "SEQUENCE")))
    {
      ...
      {
        if (hparse_errno > 0) return;
        if (hparse_f_qualified_name_of_object(TOKEN_REFTYPE_DATABASE_OR_SEQUENCE, TOKEN_REFTYPE_SEQUENCE) == 0) hparse_f_error();
        if (hparse_errno > 0) return;
      } while (hparse_f_accept(FLAG_VERSION_MYSQL_OR_MARIADB_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_OPERATOR, ","));
      if (hparse_errno > 0) return;
    }
  ...
  else if (hparse_f_accept(FLAG_VERSION_MYSQL_OR_MARIADB_ALL, TOKEN_REFTYPE_ANY,TOKEN_KEYWORD_LOAD, "LOAD"))
  {
    ...
    else if (hparse_f_accept(FLAG_VERSION_MYSQL_OR_MARIADB_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_KEYWORD, "XML") == 1)
    {
      ...
      if (hparse_f_accept(FLAG_VERSION_MYSQL_OR_MARIADB_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_OPERATOR, "(") == 1)
      {
        do
        {
          if (hparse_f_qualified_name_of_operand(false,false,false) == 0)
          {
            hparse_f_expect(FLAG_VERSION_MYSQL_OR_MARIADB_ALL, TOKEN_REFTYPE_VARIABLE,TOKEN_TYPE_IDENTIFIER,  "[identifier]");
          }
          if (hparse_errno > 0) return;
  ...
  else if (hparse_f_accept(FLAG_VERSION_TARANTOOL, TOKEN_REFTYPE_ANY,TOKEN_KEYWORD_PRAGMA, "PRAGMA") == 1)
  {
    ...
    main_token_flags[hparse_i_of_last_accepted] |= TOKEN_FLAG_IS_START_STATEMENT | TOKEN_FLAG_IS_DEBUGGABLE;
    if ((hparse_f_accept(FLAG_VERSION_TARANTOOL, TOKEN_REFTYPE_ANY,TOKEN_KEYWORD_BUSY_TIMEOUT, "BUSY_TIMEOUT") == 1)
     || (hparse_f_accept(FLAG_VERSION_TARANTOOL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_KEYWORD, "CASE_SENSITIVE_LIKE") == 1)
     || (hparse_f_accept(FLAG_VERSION_TARANTOOL, TOKEN_REFTYPE_ANY,TOKEN_KEYWORD_COLLATION_LIST, "COLLATION_LIST") == 1)
...
int MainWindow::hparse_f_client_statement()
{
  ...
  else if (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_KEYWORD_SET, "SET") == 1)
  {
    ...
    if ((hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_STATEMENT_TEXT_COLOR") == 1)
     ...
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_STATEMENT_TOP") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_STATEMENT_LEFT") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_STATEMENT_WIDTH") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_STATEMENT_HEIGHT") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_STATEMENT_DETACHED") == 1)
     ...
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_GRID_TOP") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_GRID_LEFT") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_GRID_WIDTH") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_GRID_HEIGHT") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_GRID_DETACHED") == 1)
     ...
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_HISTORY_HEIGHT") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_HISTORY_LEFT") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_HISTORY_MAX_ROW_COUNT") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_HISTORY_TOP") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_HISTORY_WIDTH") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_HISTORY_DETACHED") == 1)
     ...
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_DEBUG_TOP") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_DEBUG_LEFT") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_DEBUG_WIDTH") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_DEBUG_HEIGHT") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_DEBUG_DETACHED") == 1)
     ...
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_SHORTCUT_NEXT_WINDOW") == 1)
     || (hparse_f_accept(FLAG_VERSION_ALL, TOKEN_REFTYPE_ANY,TOKEN_TYPE_IDENTIFIER, "OCELOT_SHORTCUT_PREVIOUS_WINDOW") == 1)
